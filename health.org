...
** Current
#+begin_src emacs-lisp :var exercises=tab-exercises :colnames no :results verbatim
...
(defun health--add-to-table (tab)
  (-map #'read-string
        (health--table-headers-format tab)))

; (health--table-to-plist exercises)
; (health--add-to-table exercises)
; (health--table-headers-format exercises)
; (health--table-headers exercises)
#+end_src
** Core
#+begin_src emacs-lisp
